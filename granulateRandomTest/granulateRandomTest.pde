...
void setup()
{
  ...
  out.playNote(4.5, 3.6, new ToneInstrument( 415.3f, 0.40, out)  );
  out.playNote(4.55, 3.6, new ToneInstrument( 415.3f, 0.40, out) );
  out.playNote(4.6, 3.6, new ToneInstrument( 415.3f, 0.40, out) );
}
